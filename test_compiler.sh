...
compare_program_results () {
    ...
    # echo "got code $actual_exit_code"
    # echo "expected out $expected_out"
    # echo "got out $actual_out"
...
test_stage () {
    ...
    echo "STAGE $1"
    echo "===================Valid Programs==================="
    for prog in `find . -type f -name "*.c" -path "./stages/stage_$1/valid/*" -not -path "*/valid_multifile/*" 2>/dev/null`; do
    ...
    for dir in `ls -d stages/stage_$1/valid_multifile/* 2>/dev/null` ; do
        gcc -w $dir/*
